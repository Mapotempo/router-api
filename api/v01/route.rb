    ...
    class Route < APIBase
      ...
      resource :route do
        ...
        params {
          ...
          optional :departure, type: Date, desc: 'Departure date time (not used by all transport modes). Traffic (if used) is taken into account at this time.'
          optional :arrival, type: Date, desc: 'Arrival date time (not used by all transport modes). In exclusion with departure.'
